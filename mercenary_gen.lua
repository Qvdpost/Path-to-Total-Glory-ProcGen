...
for _, mercenary in pairs(mercenaries) do
    io.write(string.format('\t{"%s", "%s", %s, { culture = "%s", category = "%s", tier = %s }},\n', 
        mercenary.key, mercenary.group, mercenary.weight, mercenary.culture, mercenary.category, mercenary.tier)
    )
end
io.write("}\n")
